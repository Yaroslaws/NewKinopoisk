...
public class FilmsRating {
    ...
    public static By fromYear = By.xpath("//span[.='ñ:']/following::select[1]");
    public static By toYear = By.xpath("//span[.='ïî:']/following::select[1]");
    public static By ratingFilmMin = By.xpath("//input[@id = 'rating_min']");
    public static By IMDbMin = By.xpath("//input[@id = 'ex_rating_min']");
    public static By movieÑriticMin = By.xpath("//input[@id = 'tomat_rating_min']");
    ...
    public static By showFilmButton = By.xpath("//input[@value = 'ïîêàçàòü ôèëüìû']");
