...
public class MyStepdefs {
    ...
    @Тогда("^ищем фильм снятый в \"([^\"]*)\" с \"([^\"]*)\" по \"([^\"]*)\" рейтинг \"([^\"]*)\" ibm \"([^\"]*)\" рейтинг критиков \"([^\"]*)\" положительных рецензий от \"([^\"]*)\" до \"([^\"]*)\"$")
    public void ищемФильмСнятыйВСПоРейтингIbmРейтингКритиковПоложительныхРецензийОтДо(String arg1, String arg2, String arg3, String arg4, String arg5, String arg6, String arg7, String arg8) throws Throwable {
